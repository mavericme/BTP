...
#	print b
	return render_template('test2.html',b=b);
...
#	print request.args;
	dic2 = OrderedDict();
	dic2['fname'] = '32';
	url = "http://www.espncricinfo.com/zimbabwe-domestic-2014-15/engine/match/793687.html"#"http://www.espncricinfo.com/bangladesh-v-zimbabwe-2014-15/engine/match/760785.html";
#	url="http://www.espncricinfo.com/south-africa-domestic-2014-15/engine/match/783895.html";
	t = lxml.html.parse(url)
	data = t.find(".//title").text
	l = []
	l = data.split()
	se = l[1].split('/')[0];
	print se
...
#	print b
	b = se
	print b
	return render_template('null.html',b=b);
...
def chart():
	if request.method == "POST":
			...
			for i in w:
				...
				for j in p:
					if str(j)==y:
						l.append(int(p[j]))
		if graph == "bar":
			return render_template('graph_bar.html',t=t[:10],l=l,x=x,y=y)
		if graph == "pie":
			mehe = {}
			for x in t:
				if x in mehe:
		...
		if graph == "histogram":
			return render_template('graph_hist.html',t=t[:10],l=l,x=x,y=y)
